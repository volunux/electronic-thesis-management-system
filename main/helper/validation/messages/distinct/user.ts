...
export const userMessages : { [key : string] : any } = {
	...
	'new_password' : ValidationMessageType.getStringInstance(true , 8 , 30 , false , true , 'String') ,
	...
	'user_status' : ValidationMessageType.getIntegerInstance(true , 1 , 900000000 , false , true , 'Number or String')
