...
export class SearchQueryOptions {
	...
	public getSearchQueryJoinOptions() : SearchQueryJoinOptions {

		return this.searchQueryJoinOptions;
	}

	public getSearchQueryConditionOptions() : SearchQueryConditionOptions {

		return this.searchQueryConditionOptions;
	}

	public static getInstance() : SearchQueryOptions {
