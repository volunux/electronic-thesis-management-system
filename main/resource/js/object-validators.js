...
function validateObjectSignature(choosenFile , fileUploadButton , fileTextElement , customButtonElement , validationStatus) {
		...
		if (evt.target.readyState === FileReader.DONE) {
			...
			var signatureType = getObjectTypeFromMagicNumber(hex);
...
function deleteObject(choosenFile , fileUploadButton , fileTextElement , fileUploadButtonCancel , fileUploadButtonDelete , customButtonElement , key) {
	...
	var objectRemover = new XMLHttpRequest();
	...
	objectRemover.setRequestHeader('Accept' , 'application/json');
